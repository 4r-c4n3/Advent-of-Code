...
name = ['Bob','Carol','David','Eric','Frank','George','Mallory','Alice','me']
dict = {}
var = ''
total_happpiness = 0
for i in name:
...
sitting = {'Bob':0,'Carol':0,'David':0,'Eric':0,'Frank':0,'George':0,'Mallory':0,'Alice':0,'me':0}
couple = [""]* 9
happiness = [0] * 9
count = 0
...
#cant code ot..just just i add myself between least happy couple resulting in 0 
#happiness btween 3 on us(2 couples)
#its 709(total happiness) - 41(sadness coz of me) = 668(new happines) 